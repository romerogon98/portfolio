    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          // Use the button's own theme vars (not the site-inlined foreground/
          // background utilities) so the label inverts against the fill.
          showFill && "text-[var(--ic-background)]",
          className
        )}
