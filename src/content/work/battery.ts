...
export const battery: CaseStudy = {
  slug: "battery",
  title: "Battery",
  ...
  role: "[Your role]",
  duration: "[Duration]",
  heroImage: "/work/battery/hero.jpg",
  tint: "from-zinc-700 to-neutral-950",
  intro:
