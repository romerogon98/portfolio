...
export const realoption: CaseStudy = {
  slug: "realoption",
  title: "Realoption",
  ...
  role: "[Your role]",
  duration: "[Duration]",
  heroImage: "/work/realoption/hero.jpg",
