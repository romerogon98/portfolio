...
export const pinamar: CaseStudy = {
  slug: "pinamar",
  title: "Pinamar",
  ...
  role: "[Your role]",
  duration: "[Duration]",
  heroImage: "/work/pinamar/hero.jpg",
  tint: "from-amber-800 to-stone-950",
  theme: "light",
  intro:
